...
#ifndef ASCENDC_DISPATCH_FFN_COMBINE_BF16_TILING_H
#define ASCENDC_DISPATCH_FFN_COMBINE_BF16_TILING_H
struct DispatchFFNCombineBF16Info {
    uint32_t M;
    uint32_t K;
    uint32_t N;
...
struct DispatchFFNCombineBF16TilingData {
    Mc2InitTiling mc2InitTiling;
    Mc2CcTiling mc2CcTiling;
    DispatchFFNCombineBF16Info dispatchFFNCombineBF16Info;
    CoCTiling cocTiling;
};
#endif