...
/*!
 * \file dispatch_ffn_combine_w4a8.h
 * \brief
 */

#ifndef DISPATCH_FFN_COMBINE_W4A8_H
#define DISPATCH_FFN_COMBINE_W4A8_H
...
#include "dispatch_ffn_combine_w4_a8_kernel.hpp"
#include "moe_init_routing_quant_v2/moe_init_routing_quant_v2_tiling.h"

using namespace Catlass;
using namespace AscendC::HcclContextDef;

namespace DispatchFFNCombineW4A8Impl {
                                                                    ...
                                                                    GM_ADDR probs, GM_ADDR xActiveMaskGM, GM_ADDR outGM, GM_ADDR expertTokenNums, GM_ADDR workspaceGM, GM_ADDR tilingGM)
{
    ...
    m = tilingData.dispatchFFNCombineW4A8Info.M;
    k = tilingData.dispatchFFNCombineW4A8Info.K;
    n = tilingData.dispatchFFNCombineW4A8Info.N;
    EP =  tilingData.dispatchFFNCombineW4A8Info.worldSize;
    topK = tilingData.dispatchFFNCombineW4A8Info.topK;
...
template <TemplateMMA2AClass>
__aicore__ inline void DispatchFFNCombineW4A8<TemplateMMA2ACFunc>::Process()
{
    // Define ArchTag
    ...
    using DispatchPolicy = Gemm::MmadAtlasA2W4A4MatmulPerChannelDequant<
        preloadStages,
    ...
    using BType = Gemm::GemmType<AscendC::int4b_t, LayoutB>;
    ...
    using EpilogueDispatchPolicy2 = Epilogue::EpilogueAtlasA2W4A8PostPerTokenDequantV2<ubStages>;
    ...
    using MatmulKernel = Gemm::Kernel::DispatchFFNCombineW4A8Kernel<BlockMmad,
