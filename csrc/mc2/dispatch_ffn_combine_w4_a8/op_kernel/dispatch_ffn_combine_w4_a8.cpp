...
extern "C" __global__ __aicore__ void dispatch_ffn_combine_w4_a8(GM_ADDR x, GM_ADDR w1, GM_ADDR w2,  GM_ADDR expertId, GM_ADDR scale1, GM_ADDR scale2, GM_ADDR bias1, GM_ADDR bias2, GM_ADDR probs,
    GM_ADDR xActiveMask, GM_ADDR c, GM_ADDR expertTokenNums, GM_ADDR workspaceGM,  GM_ADDR tilingGM)
{
    ...
    if (TILING_KEY_IS(1000010)) {
        ...
        op.Init(x, w1, w2, expertId, scale1, scale2, bias1, bias2, probs, xActiveMask, c, expertTokenNums, workspaceGM, tilingGM);
        op.Process();
    }
}