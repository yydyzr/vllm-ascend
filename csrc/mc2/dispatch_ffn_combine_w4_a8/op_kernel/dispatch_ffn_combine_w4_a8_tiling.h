...
#ifndef ASCENDC_DISPATCH_FFN_COMBINE_W4A8_TILING_H
#define ASCENDC_DISPATCH_FFN_COMBINE_W4A8_TILING_H
struct DispatchFFNCombineW4A8Info {
    uint32_t M;
    uint32_t K;
    uint32_t N;
...
struct DispatchFFNCombineW4A8TilingData {
    Mc2InitTiling mc2InitTiling;
    Mc2CcTiling mc2CcTiling;
    DispatchFFNCombineW4A8Info dispatchFFNCombineW4A8Info;
    CoCTiling cocTiling;
};
#endif