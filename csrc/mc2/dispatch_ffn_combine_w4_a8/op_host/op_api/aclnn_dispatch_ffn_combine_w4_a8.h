...
#ifndef OP_API_INC_DISPATCH_FFN_COMBINE_W4A8_
#define OP_API_INC_DISPATCH_FFN_COMBINE_W4A8_
...
__attribute__((visibility("default"))) aclnnStatus aclnnDispatchFFNCombineW4A8(void* workspace, uint64_t workspaceSize, aclOpExecutor* executor,
                                           aclrtStream stream);
...
#endif  // OP_API_INC_DISPATCH_FFN_COMBINE_W4A8_