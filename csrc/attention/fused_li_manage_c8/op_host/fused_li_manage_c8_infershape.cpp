...
namespace ops {
// Direct 10-input layout: see fused_li_manage_c8_tiling.h
constexpr uint32_t QUERY_INDEX = 0;
constexpr uint32_t KEY_INDEX = 1;
constexpr uint32_t CACHE_SLOTS_INDEX = 6;
constexpr int64_t DECODE_OUTPUT_CAPACITY = 2048;

static ge::graphStatus InferShapeFusedLiManageC8(gert::InferShapeContext *context)
{
    OPS_ERR_IF(context == nullptr, OPS_LOG_E("FusedLiManageC8", "InferShapeContext is nullptr."),
...
static ge::graphStatus InferDataTypeFusedLiManageC8(gert::InferDataTypeContext *context)
{
    OPS_ERR_IF(context == nullptr, OPS_LOG_E("FusedLiManageC8", "InferDataTypeContext is nullptr."),
               return ge::GRAPH_FAILED);
...
IMPL_OP_INFERSHAPE(FusedLiManageC8)
    .InferShape(InferShapeFusedLiManageC8)
    .InferDataType(InferDataTypeFusedLiManageC8);
} // namespace ops
