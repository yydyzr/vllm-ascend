...
/*!
 * \file sparse_tail_attention_def.cpp
 * \brief
 */
...
namespace ops {
class SparseTailAttention : public OpDef {
public:
    explicit SparseTailAttention(const char *name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
