 ...
 */
 ...
 /*!
 * \file sparse_tail_attention.cpp
 * \brief
 */

#include "kernel_operator.h"
#include "sparse_tail_attention_template_tiling_key.h"
#include "sparse_tail_attention_kernel_mla.h"
...
#define SFA_OP_IMPL(templateClass, tilingdataClass, ...)                                          \
    do {                                                                                          \
	    ...
	    blocktable, queryRope, keyRope, attentionOut, nullptr, nullptr, nullptr, nullptr,         \
        nullptr, nullptr, user, tiling_data, tiling, &tPipe);                                     \
        op.Process();                                                                             \
    } while (0)

template<int FLASH_DECODE, int LAYOUT_T, int KV_LAYOUT_T, int TEMPLATE_MODE>
 __global__ __aicore__ void
sparse_tail_attention(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                       __gm__ uint8_t *sparseIndices, __gm__ uint8_t *cacheTokens, __gm__ uint8_t *blocktable,
