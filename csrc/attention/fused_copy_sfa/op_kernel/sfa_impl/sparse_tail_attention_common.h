...
/*!
 * \file sparse_tail_attention_common.h
 * \brief
 */

#ifndef STA_IMPL_SPARSE_TAIL_ATTENTION_COMMON_H
#define STA_IMPL_SPARSE_TAIL_ATTENTION_COMMON_H
...
struct RunInfo {
    ...
    uint32_t sparseValidBlockCount = 0;
...
#endif // STA_IMPL_SPARSE_TAIL_ATTENTION_COMMON_H
