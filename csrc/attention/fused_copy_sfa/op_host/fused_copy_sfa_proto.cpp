...
ge::graphStatus InferShapeFusedCopySfa(
    gert::InferShapeContext *context)
{
    OPS_ERR_IF(context == nullptr,
               OPS_LOG_E("FusedCopySfa",
...
ge::graphStatus InferDtypeFusedCopySfa(
...
IMPL_OP(FusedCopySfa)
    .InferShape(InferShapeFusedCopySfa)
    .InferDataType(InferDtypeFusedCopySfa);
